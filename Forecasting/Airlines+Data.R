library(readxl)
Airlines <- read_excel("E:/Data Science/Assignments/Forecasting/Airlines+Data.xlsx")
View(Airlines)
...
# Additive seasonality with Multiplicative has least RMSE value

write.csv(trakdata,file="trakdata.csv")

####################### Predicting new data #############################
setwd("E://Data Science//Assignments//Forecasting")
